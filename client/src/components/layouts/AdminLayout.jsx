...
const adminNavItems = [
  ...
  { to: "/groups", label: "Groups", icon: Building },
  { to: "/meetings", label: "Meetings", icon: Bell },
  { to: "/chat", label: "Chat", icon: MessageSquare },
  { to: "/members", label: "Members", icon: Users },
  { to: "/loans", label: "Loans", icon: DollarSign },
  { to: "/loan-assessment", label: "Loan Assessment", icon: Calculator },
  { to: "/savings", label: "Savings", icon: DollarSign },
